...
**نگارش فارسی: ساده.** جمله‌ها کوتاه‌اند و کلمه‌ها روزمره. به‌جای «مقید می‌کند»
می‌نویسیم «محدود می‌کند»؛ به‌جای «خاستگاه داده» می‌نویسیم «داده از کجا آمده».
هر متنی که با یک بار خواندن فهمیده نشود، بازنویسی شده است.
